      ...
      <div className='flex flex-wrap justify-between w-[100%]'>
         <div className='reason_1 w-[250px] md:w-[45%] md:mb-[8px] md:py-[12px] md:mr-[8px]'>
             ...
             <div className='main_reason'>
                 <h1 className="text-[#2F2F2F] font-medium text-2xl md:text-[14px] md:leading-[17px]">Custom Packaging Solutions</h1>
                 <p className="text-[#2F2F2F] pt-2 md:text-[12px] md:mt-[5px] md:leading-[14.5px]">Tailored to Your Brand, Budget, and Product Requirements</p>
             </div>
         </div>
         <div className='reason_2 w-[250px] md:w-[45%] md:mb-[8px] md:py-[12px] md:mr-[8px]'>
             ...
             <div className='main_reason'>
                 <h1 className="text-[#2F2F2F] font-medium text-2xl md:text-[14px] md:leading-[17px]">Reliable Packaging  Services</h1>
                 <p className="text-[#2F2F2F] pt-2 md:text-[12px] md:mt-[5px] md:leading-[14.5px]">Consistent Quality and On-Time <br/>Delivery</p>
             </div>
         </div>
         <div className='reason_3 w-[260px] md:w-[45%] md:mb-[8px] md:py-[12px] md:mr-[8px]'>
             ...
             <div className='main_reason w-[100%]'>
                 <h1 className="text-[#2F2F2F] font-medium text-2xl md:text-[14px] md:leading-[17px]">Exceptional Customer Support</h1>
                 <p className="text-[#2F2F2F] pt-2 md:text-[12px] md:mt-[5px] md:leading-[14.5px]">Dedicated to Providing Impeccable Customer Experience</p>
             </div>
         </div>
         <div className='reason_4 w-[250px] md:w-[45%] md:mb-[8px] md:py-[12px] md:mr-[8px]'>
             ...
             <div className='main_reason'>
                 <h1 className="text-[#2F2F2F] font-medium text-2xl md:text-[14px] md:leading-[17px]">Affordable Packaging Solutions</h1>
                 <p className="text-[#2F2F2F] pt-2 md:text-[12px] md:mt-[5px] md:leading-[14.5px]">Get the Best Value for Your Packaging Investment</p>
             </div>
         </div>
      </div>
    </div>
