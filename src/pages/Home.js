...
const Home = () => {
  ...
  return (
    <>
      <div className='hero1 w-[100%]'>
        <div className='flex justify-between mx-[60px] md:mx-[12px] md:block md:flex-col md:items-center mt-[76px]'>
          ...
          <div className='hero-text'>
            ...
            <p className='text-custom-text-darkGrey font-light text-[24px] pt-10 ll:pt-3 md:pt-[6px] md:text-[14px]'>Your Brand, Our Box: Crafting Packaging Magic with<br /> InkPrint.</p>
      ...
      <div className='aboutus-hero bg-[#E7E1C3] px-[60px] md:px-[12px] md:py-[12px] py-[37px] flex justify-center items-center'>
        <div className='about-wrapp '>
          <div className='about-wrapper border-solid border-4 border-[#FFFFFF] top-[50px] md:top-[50px] left-[180px] lg:left-[150px] md:right-[500px] rounded-[25px] p-[32px] shadow-md md:border-none md:p-0 md:shadow-none'>
      ...
      <div className='partners mx-[60px] md:mx-[12px] mt-[100px] md:mt-[24px]'>
        <div className='ourpartner flex items-center'>
          ...
          <hr className='w-[583px] md:w-[120px] border-green border-t-2 ml-2' />
        </div>
        <div className='partners-images flex justify-between items-center mt-[40px] md:mt-[12px]'>

          <img src={partner} alt='ficci image' className='h-[90px] w-[120px] md:h-[45px] md:w-[60px] object-contain' />
          <img src={partner2} alt='honda image' className='h-[90px] w-[120px]  md:h-[45px] md:w-[60px] object-contain' />
          <img src={partner3} alt='ixigo image' className='h-[90px] w-[120px] md:h-[45px] md:w-[60px] mt-3 object-contain' />
          <img src={partner4} alt='live mint image' className='h-[90px] w-[120px] md:h-[45px] md:w-[60px]  mt-3 object-contain' />
          <img src={partner5} alt='harvard business review image' className='h-[90px] w-[120px]  md:h-[45px] md:w-[60px] mt-3 object-contain' />
          <img src={partner6} alt='oxford image' className='h-[90px] w-[120px]  md:h-[45px] md:w-[60px]  object-contain' />
